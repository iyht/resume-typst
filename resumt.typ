...
- I developed and maintained the IPsec VPN for FortiOS.
- *TCP support for IKEv2 and IPsec*: Implemented RFC 8229 that encapsulates the IKEv2 and IPsec traffic in TCP to bypass the firewall.
...
- I developed and maintained the backend of the Multi-Geo Search Engine.
